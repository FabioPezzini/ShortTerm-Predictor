...
settimane(1:52,1) = 1:52;
settimaneVal(1:51,1) = 1:51;
...
y= mer;
y(1,:) = [];
y1 = y(1:52); %tolgo il primo che e' solo un dato e stimo l' 81 esimo
...
%Qui la migliore e' senza dubbio la Lineare di Ordine 2